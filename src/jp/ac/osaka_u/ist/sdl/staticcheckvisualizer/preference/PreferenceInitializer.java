...
public class PreferenceInitializer extends AbstractPreferenceInitializer{
	...
	public void initializeDefaultPreferences() {
		...
		store.setDefault(PreferenceKey.GENERATE_COMMAND, Config.getInstance().DEFAULT_GENERATE_COMMAND);
		store.setDefault(PreferenceKey.OUTPUT_DIR, WorkspaceManager.getWorkspaceDirPath());
		store.setDefault(PreferenceKey.EDGE_MAX_LEVEL, Config.getInstance().DEFAULT_EDGE_MAX_LEVEL);
		store.setDefault(PreferenceKey.METHODVIEW_ATTRIBUTE_COLUMN_COUNT, Config.getInstance().DEFAULT_METHODVIEW_ATTRIBUTE_COLUMN_COUNT);
	}
}
